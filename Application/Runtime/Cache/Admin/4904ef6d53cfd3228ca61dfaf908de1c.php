    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="" class="am-icon-home">管理员列表</a></li>
             ...
             <div class="tpl-block">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        <div class="tpl-form-body tpl-form-line">
                            <!--添加商品表单 -->
                            <form class="am-form am-form-horizontal" method="post" action="<?php echo U('actionUpDate');?>">
                                <br>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">管理员名</label>
                                    <div class="am-u-sm-5 am-u-end">
                                        <input type="text" name="name" id="user-name" value="<?php echo ($list["username"]); ?>" disabled >
                                        <input type="hidden" name="id" value="<?php echo ($list["id"]); ?>">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="doc-ipt-pwd-2" class="am-u-sm-3 am-form-label">密　码：</label>
                                    <div class="am-u-sm-5 am-u-end">
                                        <input type="text" name="password"  placeholder="不填写则用原来的密码">
                                        <!-- <small>没有密码什么都干不了</small> -->
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-5 am-u-end">
                                        <input type="text" name="repassword" id="" placeholder="不填写则用原来的密码">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="tpl-switch">
                                            <input type="checkbox" name="status" class="ios-switch bigswitch tpl-switch-btn" <?php echo ($list['status']==1?checked:''); ?> value="<?php echo ($list["status"]); ?>"/>
        ...
        <script>
            //点击返回
            $('#back').click(function() {
                location.href = '/thinkphp_3.2.3_full/index.php/Admin/Adminuser/index';
            });
