...
<body data-type="login">
  ...
  <div class="am-g myapp-login">
	<div class="myapp-login-logo-block  tpl-login-max">
		...
		<div class="am-u-sm-10 login-am-center">
			<form class="am-form" action="<?php echo U('Login/dologin');?>" method="post">
				<fieldset>
					<div class="am-form-group">
						<input type="text" name="user" class="" id="doc-ipt-email-1" placeholder="请输入登录账号">
					</div>
					<div class="am-form-group">
						<input type="password" class="" name="pass" id="doc-ipt-pwd-1" placeholder="请输入登录密码">
					</div>
  ...
  <script src="/thinkphp_3.2.3_full/Public/assets/js/jquery.min.js"></script>
  <script src="/thinkphp_3.2.3_full/Public/assets/js/amazeui.min.js"></script>
  <script src="/thinkphp_3.2.3_full/Public/assets/js/app.js"></script>
</body>
