                ...
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" method="post" action="<?php echo U('changeClassify');?>">
                                <div class="am-form-group">
                                    <label for="user-weio" class="am-u-sm-3 am-form-label">原分类名字 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <?php echo ($firstSort["name"]); ?>
                                    <div></div>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                ...
                                <input type="hidden" name="id" value="<?php echo ($firstSort["id"]); ?>">
                                <!--分类添加下拉框 -->
