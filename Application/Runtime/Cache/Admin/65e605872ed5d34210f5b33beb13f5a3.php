    ...
    <div class="tpl-page-container tpl-page-header-fixed">
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="/thinkphp_3.2.3_full/index.php/Admin/User/addUser"><button type="button" class="am-btn am-btn-default am-btn-success am-btn-xs"><span class="am-icon-plus"></span> 新增</button></a>
                                    <a href="/thinkphp_3.2.3_full/index.php/Admin/User/index"><button type="button" class="am-btn am-btn-default am-btn-success am-btn-xs"><span class="am-icon-plus"></span>清空搜索条件</button></a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                            ...
                                            <td>
                                                <div class="tpl-switch">
                                                    <input type="checkbox" name="status" class="ios-switch bigswitch tpl-switch-btn " <?php echo ($v['status']==2?checked:''); ?> value="<?php echo ($v["status"]); ?>"/>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary upuser" uid="<?php echo ($v["id"]); ?>"><span class="am-icon-pencil-square-o" ></span> 编辑</button>
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only deluser" uid="<?php echo ($v["id"]); ?>"><span class="am-icon-trash-o"></span> 删除</button>
                                                    </div>
                                                </div>
                                            </td>
        ...
        $('.changestatus').each(function() {
            ...
            $(this).click(function() {
                ...
                $.post(
                    '<?php echo U("Admin/User/changestatus");?>',
        ...
        //点击编辑
         $('.upuser').each(function() {
            $(this).click(function () {
                ...
                location.href = '/thinkphp_3.2.3_full/index.php/Admin/User/upUser/id/'+id;
            });
        });
        ...
        $('#seachNameBtn').click(function() {
            ...
            location.href = '/thinkphp_3.2.3_full/index.php/Admin/User/index/name/'+name;
        });
