             ...
             <div class="tpl-block">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        <div class="tpl-form-body tpl-form-line">
                            <!--添加商品表单 -->
                            <form class="am-form am-form-horizontal" method="post" action="<?php echo U('actionAddUser');?>">
                                <br>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">用户名</label>
                                    <div class="am-u-sm-5 am-u-end">
                                        <input type="text" name="name" id="user-name" placeholder="用户名字长度应在3~18个字符">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="tpl-switch">
                                            <input type="checkbox" name="status" class="ios-switch bigswitch tpl-switch-btn" checked value="2"/>
