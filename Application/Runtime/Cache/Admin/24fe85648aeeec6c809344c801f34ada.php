...
<body data-type="index">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                            ...
                                            <td class="am-hide-sm-only"><?php echo ($v["function"]); ?></td>
                                            <td class="am-hide-sm-only"><?php echo (subtext($v["rules"],20)); ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary edituser" gid="<?php echo ($v["id"]); ?>"><span class="am-icon-pencil-square-o" ></span> 成员管理</button>
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-warning editgroup" gid="<?php echo ($v["id"]); ?>"><span class="am-icon-pencil-square-o" ></span>权限管理</button>

                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only delgroup" gid="<?php echo ($v["id"]); ?>"><span class="am-icon-trash-o"></span> 删除</button>
                                                    </div>
                                                </div>
                                            </td>
    ...
    <script>
        ...
        $('#addGroup').click(function() {
            location.href = '/thinkphp_3.2.3_full/index.php/Admin/Authgroup/addgroup';
        });
        //点击成员管理
        $('.edituser').each(function() {
            $(this).click(function () {
                var id = $(this).attr('gid');
                location.href = '/thinkphp_3.2.3_full/index.php/Admin/Authgroup/edituser/id/'+id;
            });
        });
        //点击权限管理
         $('.editgroup').each(function() {
            $(this).click(function () {
                var id = $(this).attr('gid');
                location.href = '/thinkphp_3.2.3_full/index.php/Admin/Authgroup/editgroup/id/'+id;
            });
        });
        //点击删除
        $('.delgroup').each(function() {
            ...
            $(this).click(function () {
                var id = $(this).attr('gid');
                $.post(
                    '<?php echo U("Admin/Authgroup/delgroup");?>',
                    {id:id},
                    function (data) {
                        if (data == 1) {
        ...
        $('.changestatus').each(function() {
            ...
            $(this).click(function() {
                ...
                $.post(
                    '<?php echo U("Admin/Authgroup/changestatus");?>',
