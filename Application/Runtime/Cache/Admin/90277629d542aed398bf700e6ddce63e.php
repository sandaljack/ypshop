    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            <ol class="am-breadcrumb">
                ...
                <li><a href="#">商品管理</a></li>
                <li><a href="#">商品信息</a></li>
                <li class="am-active">库存修改</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span>库存修改
                    </div>
                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        <div class="tpl-form-body tpl-form-line">
                            <!--添加商品表单 -->
                            <form class="am-form am-form-horizontal" method="post" action="<?php echo U('changestore');?>" enctype="multipart/form-data">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-5 am-u-end">
                                        <input type="text" name="store" id="user-name" value="<?php echo ($storeData['store']); ?>">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">尺码</label>
                                    <div class="am-u-sm-5 am-u-end">
                                        <input type="text" name="size" id="user-name" value="<?php echo ($storeData['size']); ?>">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">颜色</label>
                                    <div class="am-u-sm-5 am-u-end">
                                        <input type="text" name="color" id="user-name" value="<?php echo ($storeData['color']); ?>">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">价格</label>
                                    <div class="am-u-sm-5 am-u-end">
                                        <input type="text" name="price" id="user-name" value="<?php echo ($storeData['price']); ?>">
                                    </div>
                                </div>
                                <input type="hidden" name="storeId" value="<?php echo ($storeData['id']); ?>" id="user-name">
