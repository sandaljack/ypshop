            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    ...
                    <div class="am-u-sm-9 am-u-sm-push-8">
                        <a href="/thinkphp_3.2.3_full/index.php/Admin/Goodstore/addStore/id/<?php echo ($gid); ?>"><button class="am-btn am-btn-primary tpl-btn-bg-color-success ">插入库存
                        </button></a>
                        <a href="/thinkphp_3.2.3_full/index.php/Admin/Showgoods/showgood"><button class="am-btn am-btn-primary tpl-btn-bg-color-success ">返回
                        </button></a>
                    </div>
                        ...
                        <div id="myDiv" class="am-u-sm-12">
                            <form class="am-form">
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody id="mytbody">                                    
                                        <?php if(is_array($storeData)): foreach($storeData as $key=>$v): ?><tr class="am-text-center">
                                                <td class="table-id"><?php echo ($v["id"]); ?></td>
                                                <td class="am-hide-sm-only"><?php echo ($goodName['goods_name']); ?></td>
                                                <td class="am-hide-sm-only"><?php echo ($v["size"]); ?></td>
                                                <td class="am-hide-sm-only"><?php echo ($v["color"]); ?></td>
                                                <td class="am-hide-sm-only"><?php echo ($v["store"]); ?></td>
                                                <td class="am-hide-sm-only">￥<?php echo ($v["price"]); ?></td>
                                                <td>
                                                    <div class="am-btn-toolbar">
                                                        <div class="am-btn-group am-btn-group-xs">
                                                            <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><a href="/thinkphp_3.2.3_full/index.php/Admin/Goodstore/changeStore/id/<?php echo ($v["id"]); ?>/goodid/<?php echo ($v["goods_id"]); ?>">修改</a></button>
                                                            <button num="<?php echo ($v["id"]); ?>" mes="<?php echo ($v["goods_id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only myDelete"><a href="javascript:;">删除</a></button>
                                                        </div>
                                                    </div>
                                                </td>
                                        ...
                                        <tr>
                                            <td class="am-text-center" colspan="7">
                                                <?php if($storeData == null): ?><div>未有相关数据</div><?php endif; ?> 
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        $('.myDelete').on('click', function ()
        {
            ...
            if (confirm(msg) == true) {
                ...
                $.post(
                    ...
                    '/thinkphp_3.2.3_full/index.php/Admin/Goodstore/deleteStore',
