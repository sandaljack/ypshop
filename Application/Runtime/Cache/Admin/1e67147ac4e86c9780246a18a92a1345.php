...
<body data-type="index">
                    ...
                    <div class="am-u-sm-10 am-u-sm-offset-1">
                        <div class="tpl-form-body tpl-form-line">
                            ...
                            <section data-am-widget="accordion" class="am-accordion am-accordion-gapped" data-am-accordion='{  }'>
                                <?php if(is_array($firstsortData)): foreach($firstsortData as $key=>$value): ?><dl class="am-accordion-item am-active" firstsortId="<?php echo ($value["id"]); ?>">
                                        ...
                                        <dd class="am-accordion-bd am-collapse">
                                          <!-- 规避 Collapase 处理有 padding 的折叠内容计算计算有误问题， 加一个容器 -->
                                            ...
                                            <div class="am-btn-group">
                                              <a href="/thinkphp_3.2.3_full/index.php/Admin/Classify/changeClassify/id/<?php echo ($value["id"]); ?>"><button type="button" class="am-btn am-btn-default">编辑</button></a>
                                              <a style="margin-left:-5px" href="javascript:"><button type="button" firstsortId="<?php echo ($value["id"]); ?>" class="am-btn am-btn-default myDelete">删除</button></a>
                                            </div>
                                        </dd>
    ...
    $('.am-accordion').on('click', 'dl', function () {
        ...
        $.post(
            ...
            '/thinkphp_3.2.3_full/index.php/Admin/Classify/ajaxshowClassify',
        ...
        $('.myDelete').on('click', function ()
        {
            ...
            if (confirm(msg) == true) {
                ...
                $.post(
                    ...
                    '/thinkphp_3.2.3_full/index.php/Admin/Classify/deleteClassify',
        ...
        $('.am-accordion').on('click','.myDelete2' ,function ()
        {
            ...
            if (confirm(msg) == true) {
                ...
                $.post(
                    ...
                    '/thinkphp_3.2.3_full/index.php/Admin/Classify/deletesecondClassify',
