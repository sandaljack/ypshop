...
<body data-type="index">
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button id="adduser" type="button" class="am-btn am-btn-default am-btn-success" gid="<?php echo ($group["id"]); ?>"><span class="am-icon-plus" ></span> 添加成员</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
                                        <?php if(is_array($userlist)): foreach($userlist as $key=>$v): ?><tr>
                                            ...
                                            <td class="am-hide-sm-only"><?php echo ($group["title"]); ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
    ...
    <script>
        ...
        $('#adduser').click(function() {
            ...
            location.href = '/thinkphp_3.2.3_full/index.php/Admin/Authgroup/adduser/id/'+id;
        });
          //点击删除
        $('.deluser').each(function() {
            ...
            $(this).click(function () {
                ...
                $.post(
                    '<?php echo U("Admin/Authgroup/deluser");?>',
                    {gid:gid, uid:uid},
                    function (data) {
                        if (data == 1) {
