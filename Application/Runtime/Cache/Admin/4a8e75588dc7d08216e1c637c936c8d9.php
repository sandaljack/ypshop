...
<body data-type="index">
                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        <div class="tpl-form-body tpl-form-line">
                            ...
                            <form class="am-form am-form-horizontal" method="post" action="<?php echo U('editFriendlink');?>" enctype="multipart/form-data">
                                 <div class="am-form-group">
                                    <label for="user-url" class="am-u-sm-3 am-form-label">友情链接logo</label>
                                    <div class="am-u-sm-5 am-u-end">
                                        <img src="/thinkphp_3.2.3_full/Public/<?php echo ($data["flogo"]); ?>" alt="" style="width:100px;height:100px">
                                        <input type="hidden" name="originlogo" value="<?php echo ($data["flogo"]); ?>">
                                        <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-url" class="am-u-sm-3 am-form-label">友情链接</label>
                                    <div class="am-u-sm-5 am-u-end">
                                        <input type="text" name="url" id="user-url" placeholder="请输入友情链接url" value="<?php echo ($data["furl"]); ?>">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">网址名称</label>
                                    <div class="am-u-sm-5 am-u-end">
                                        <input type="text" name="name" id="user-name" placeholder="请输入友情链接网址" value="<?php echo ($data["fname"]); ?>">
                                    </div>
                                </div> 
                                <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">友情链接logo <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div>
                                                <button type="button" class="am-btn am-btn-default am-btn-sm"><i class="am-icon-cloud-upload"></i> 选择要上传的文件 </button>
                                            </div>
                                            <input type="file" name="logo" id="doc-ipt-file-2">
                                        </div>
                                    </div>                             
                                <div class="am-form-group">
    ...
    //点击返回
    $('#back').click(function() {
        location.href = '/thinkphp_3.2.3_full/index.php/Admin/Friendlink/index';
    });
