                        ...
                        <div class="am-u-sm-12 am-u-md-5">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="/thinkphp_3.2.3_full/index.php/Admin/Comment/index"><button type="button" class="am-btn am-btn-default am-btn-success am-btn-xs"><span class="am-icon-plus"></span>清空搜索条件</button></a>
                                </div>
                            </div>
                        </div>
                        <form method="get" action="<?php echo U('Comment/index');?>">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
                                        <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                            ...
                                            <td><img src="/thinkphp_3.2.3_full/Public/<?php echo ($v["pic_path"]); ?>" style="width:30px;height:30px" alt=""></td>
                                            <td>
                                                <?php echo ($v["goods_name"]); ?>
                                            </td>
                                            <td><?php echo ($v["color"]); ?></td>
                                            <td><?php echo ($v["size"]); ?></td>
                                            <?php if($v['point'] == 1 ): ?><td class="am-hide-sm-only status">好评</td><?php endif; ?>
                                            <?php if($v['point'] == 2 ): ?><td class="am-hide-sm-only status">中评</td><?php endif; ?>
                                            <?php if($v['point'] == 3 ): ?><td class="am-hide-sm-only status">差评</td><?php endif; ?>
                                            <td><?php echo ($v["content"]); ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary resComment" cid="<?php echo ($v["id"]); ?>"><span class="am-icon-pencil-square-o" ></span> 回复评价</button>
                                                       <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only delComment" cid="<?php echo ($v["id"]); ?>"><span class="am-icon-trash-o"></span> 删除</button>
                                                    </div>
                                                </div>
                                            </td>
                                            <td><?php echo ($v["rescom"]); ?></td>
    ...
    <script>
        ...
        $('.resComment').each(function() {
            $(this).click(function () {
                ...
                location.href = '/thinkphp_3.2.3_full/index.php/Admin/Comment/resComment/cid/'+id;
            });
        });
