                        ...
                        <div class="am-u-sm-12 am-u-md-5">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="/thinkphp_3.2.3_full/index.php/Admin/Friendlink/addFriendlink"><button type="button" class="am-btn am-btn-default am-btn-success am-btn-xs"><span class="am-icon-plus"></span>添加友情链接</button></a>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                            ...
                                            <td><img src="/thinkphp_3.2.3_full/Public/<?php echo ($v["flogo"]); ?>" style="width:50px;height:50px" alt=""></td>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary editfriendlink" fid="<?php echo ($v["id"]); ?>"><span class="am-icon-pencil-square-o" ></span> 编辑</button>
                                                       <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only delfriendlink" fid="<?php echo ($v["id"]); ?>"><span class="am-icon-trash-o"></span> 删除</button>
                                                    </div>
                                                </div>
                                            </td>
    ...
    <script>
        ...
        $('.editfriendlink').each(function() {
            $(this).click(function () {
                ...
                location.href = '/thinkphp_3.2.3_full/index.php/Admin/Friendlink/editFriendlink/fid/'+id;
            });
        });
        ...
        $('.delfriendlink').each(function() {
            ...
            $(this).click(function () {
                var id = $(this).attr('fid');
                $.post(
                    '<?php echo U("Admin/Friendlink/delFriendlink");?>',
                    {id:id},
                    function (data) {
                        if (data == 1) {
