                    ...
                    <div class="tpl-portlet-input tpl-fz-ml">
                        <div class="portlet-input input-small input-inline">
                            <div class="input-icon right">
                             <button id="back" gid="<?php echo ($group["id"]); ?>" class="am-btn am-btn-primary" style="margin-left:20px">返回</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        <div class="tpl-form-body tpl-form-line">
                            <!--添加商品表单 -->
                            <form class="am-form am-form-horizontal" method="post" action="<?php echo U('adduser');?>" enctype="multipart/form-data">
                                <input type="hidden" name="groupid" value="<?php echo ($group["id"]); ?>">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">所属角色组</label>
                                    <div class="am-u-sm-5 am-u-end">
                                        <textarea id="user-name" name="groupid" id="" cols="10" rows="1" disabled><?php echo ($group["title"]); ?></textarea>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">用户名</label>
                                    <div class="am-u-sm-5 am-u-end">
                                        <input type="text" name="username" id="user-name" placeholder="请输入用户名">
                                    </div>
                                </div>
                                <div class="am-form-group">
