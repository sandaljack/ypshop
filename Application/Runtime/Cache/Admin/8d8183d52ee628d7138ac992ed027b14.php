...
<body data-type="index">
                        ...
                        <div class="am-u-sm-12">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                            ...
                                            <td class="am-hide-sm-only classify" classify="<?php echo ($v["classify"]); ?>"></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button  class="am-btn am-btn-default am-btn-xs am-text-secondary editrule" rid="<?php echo ($v["id"]); ?>"><span class="am-icon-pencil-square-o"></span> 编辑</button>
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only delrule" rid="<?php echo ($v["id"]); ?>"><span class="am-icon-trash-o"></span> 删除</button>
                                                    </div>
                                                </div>
                                            </td>
    ...
    $('#addrule').click(function() {
        location.href = '/thinkphp_3.2.3_full/index.php/Admin/Authrule/addrule';
    });
    //点击编辑
    $('.editrule').each(function() {
        $(this).click(function () {
            var id = $(this).attr('rid');
            location.href = '/thinkphp_3.2.3_full/index.php/Admin/Authrule/editrule/id/'+id;
        });
    ...
    $('.delrule').each(function() {
        ...
        $(this).click(function () {
            var id = $(this).attr('rid');
            $.post(
                '<?php echo U("Admin/Authrule/delrule");?>',
                {id:id},
                function (data) {
                    if (data == 1) {
    ...
    $('.changestatus').each(function() {
        ...
        $(this).click(function() {
            ...
            $.post(
                '<?php echo U("Admin/Authrule/changestatus");?>',
