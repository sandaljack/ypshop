    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="" class="am-icon-home">用户列表</a></li>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="tpl-switch">
                                            <input type="checkbox" name="status" class="ios-switch bigswitch tpl-switch-btn" <?php echo ($list['status']==2?checked:''); ?> value="<?php echo ($list["status"]); ?>"/>
        ...
        <script>
            //点击返回
            $('#back').click(function() {
                location.href = '/thinkphp_3.2.3_full/index.php/Admin/User/index';
            });
