    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            <ol class="am-breadcrumb">
                ...
                <li><a href="#">分类管理</a></li>
                <li class="am-active">分类名更改</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 分类名更改
                    </div>
                ...
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" method="post" action="<?php echo U('changesecondClassify');?>">
                                <div class="am-form-group">
                                    <label for="user-weio" class="am-u-sm-3 am-form-label">原二级分类名字 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <?php echo ($secondSort["name"]); ?>
                                    <div></div>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-weio" class="am-u-sm-3 am-form-label">要更改的分类名字 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input name="name" type="text" id="user-weibo" placeholder="请添加分类名称">
                                    <div></div>
                                    </div>
                                </div>
                                <input type="hidden" name="id" value="<?php echo ($secondSort["id"]); ?>">
                                <!--分类添加下拉框 -->
                                
                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-3 am-form-label"></label>
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" id="user-intro" ></textarea>
                                    </div>
                                </div>
                                <div class="am-form-group">
