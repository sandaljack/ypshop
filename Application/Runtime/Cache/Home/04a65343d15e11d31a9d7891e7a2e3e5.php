					...
					<div class="user-order">
						...
						<div class=" am-tabs-d2 am-margin" data-am-tabs>
							...
							<ul class="am-avg-sm-5 am-tabs-nav am-nav am-nav-tabs">
								...
								<li style="background:lightblue;"><a id="waitback">待收货</a></li>
							...
							<div class="am-tabs-bd">
								...
								<?php if(is_array($res)): foreach($res as $key=>$val): ?><div class="parent">
												<div class="order-title">
													<div class="dd-num">订单编号：<a class="order" href="javascript:;"><?php echo ($val["orders_num"]); ?></a></div>
													...
													<div class="order-right">
														...
														<div class="move-right">
															...
															<li class="td td-change">
																<div class="am-btn am-btn-danger anniu" oid="<?php echo ($val['orders_num']); ?>">
																	确认收货</div>
															</li>
														</div>
