...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<!-- 内容模块 -->
					...
					<div class="user-order">
						...
						<div class=" am-tabs-d2 am-margin" data-am-tabs>
							...
							<ul class="am-avg-sm-5 am-tabs-nav am-nav am-nav-tabs">
								<li style="background:lightblue;"><a id="allorder">所有订单</a></li>
								<li><a id="waitpay">待付款</a></li>
							...
							<div class="am-tabs-bd">
								...
								<?php if(is_array($res)): foreach($res as $key=>$val): ?><div class="order-title">
													<div class="dd-num">订单编号：<a href="javascript:;" id="order"><?php echo ($val["orders_num"]); ?></a></div>
									...
									<?php if(is_array($rest)): foreach($rest as $k=>$val2): if($val['orders_num'] == $val2[0]['orders_num'] ): if(is_array($val2)): foreach($val2 as $key=>$val3): ?><ul class="item-list">
											...
											<?php if($val['status'] == 1): ?><div class="move-right">
															...
															<li class="td td-change">
																<a href="###">
																<div oid="<?php echo ($val['orders_num']); ?>" class="am-btn am-btn-danger anniu anniu1">
																	一键支付</div></a>
															</li>
														</div><?php endif; ?>
												...
												<?php if($val['status'] == 2): ?><div class="move-right">
															<li class="td td-status">
																<div class="item-status">
															...
															<li class="td td-change">
																<div class="am-btn am-btn-danger anniu anniu2">
																	提醒发货</div>
															</li>
														</div>
		...
		<!-- ======================================== --><?php endif; ?>
												...
												<?php if($val['status'] == 3): ?><div class="move-right">
															<li class="td td-status">
																<div class="item-status">
															...
															<li class="td td-change">
																<div oid="<?php echo ($val['orders_num']); ?>"  class="am-btn am-btn-danger anniu anniu3">
																	确认收货</div>
															</li>
														</div><?php endif; ?>
												...
												<?php if($val['status'] == 4): ?><div class="move-right">
															<li class="td td-status">
																<div class="item-status">
												...
												<?php if($val['status'] == 5): ?><div class="move-right">
															<li class="td td-status">
																<div class="item-status">
																	<p class="Mystatus"></p>
													...
													<?php if($val['status'] == 6): ?><div class="move-right">
															<li class="td td-status">
																<div class="item-status">
																	<p class="Mystatus">交易成功</p>
																	<p class="order-info"><a href="<?php echo U('Order/orderInfo', array('num'=>$val['orders_num']) );?>">订单详情</a></p>
															...
															<li class="td td-change">
																<a href="##">
																	<div oid="<?php echo ($val['orders_num']); ?>" class="am-btn am-btn-danger anniu anniu6">
																		查看评价</div>
																</a>
															</li>
														</div><?php endif; ?>
				...
				$(this).click(function () {
					...
					$.post(
						...
						function (data) {
							...
							if (data == 1) {
								alert('确认收货成功！');
								location.href = '<?php echo U("Order/orders");?>';
							} else {
								alert('服务器繁忙，请稍后再试！');
							}
						},
	...
	<script>
			...
			$('.anniu6').each(function () {
				...
				location.href = "/thinkphp_3.2.3_full/index.php/Home/Comment/Commentshow/oid/"+oid+"."+"<?php echo (C("URL_HTML_SUFFIX")); ?>";
			});
													...
													<div class="order-left">
														...
														<ul class="item-list">
															<li class="td td-item">
																<div class="item-pic">
																	<a href="#" class="J_MakePoint">
																		<img src="/thinkphp_3.2.3_full/Public/<?php echo ($v1["pic_path"]); ?>" class="itempic J_ItemImg">
																	</a>
																</div>
																<div class="item-info">
																	<div class="item-basic-info">
													...
													<div class="order-left">
														...
														<ul class="item-list">
															<li class="td td-item">
																<div class="item-pic">
																	<a href="#" class="J_MakePoint">
																		<img src="/thinkphp_3.2.3_full/Public/<?php echo ($v2["pic_path"]); ?>" class="itempic J_ItemImg">
																	</a>
																</div>
																<div class="item-info">
																	<div class="item-basic-info">
													...
													<div class="order-left">
														...
														<ul class="item-list">
															<li class="td td-item">
																<div class="item-pic">
																	<a href="#" class="J_MakePoint">
																		<img src="/thinkphp_3.2.3_full/Public/image<?php echo ($v3["pic_path"]); ?>" class="itempic J_ItemImg">
																	</a>
																</div>
																<div class="item-info">
																	<div class="item-basic-info">
													...
													<div class="order-left">
														...
														<ul class="item-list">
															<li class="td td-item">
																<div class="item-pic">
																	<a href="#" class="J_MakePoint">
																		<img src="/thinkphp_3.2.3_full/Public/<?php echo ($v4["pic_path"]); ?>" class="itempic J_ItemImg">
																	</a>
																</div>
																<div class="item-info">
																	<div class="item-basic-info">
